...
@Component({
  ...
  templateUrl: './pages-manual.component.html',
  styleUrl: './pages-manual.component.scss',
  encapsulation: ViewEncapsulation.None,
})
export class PagesManualComponent implements OnInit, OnDestroy {
    ...
    try {
      this.userService
        ...
        .subscribe((data) => {
          ...
          const pagesAvailable = data.canCreateMorePages;
              ...
              this.toastService.handleMessage(
                {
                  error: {
                    message:
                      'Você precisa de um plano para acessar essa página.',
                  },
                },
                null,
                { handleRequest: true }
              ...
              this.toastService.handleMessage(
                {
                  error: {
                    message:
                      'Seu plano está com pagamento pendente. Atualize imediatamente.',
                  },
                },
                null,
                { handleRequest: true }
              ...
              this.toastService.handleMessage(
                {
                  error: {
                    message:
                      'Você chegou no limite de criação de página do seu plano atual!',
                  },
                },
                null,
                { handleRequest: true }
